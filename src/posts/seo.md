...
- [ ] Add site to Google Search console: check that the site is indexed, resolve any potential issues, add your sitemap.xml
- [ ] Add site to Bing Webmaster tools (I usually import from google search): check that the site is indexed, add your sitemap.xml
