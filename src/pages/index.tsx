  ...
  return (
    <div>
      ...
      <div>
        ...
        <a href={"mailto:leoalho@proton.me"}>leoalho@proton.me</a>. I am especially interested iin discussing projects related to health tech and the European sovereign cloud.
      </div>
    </div>
  );
};
